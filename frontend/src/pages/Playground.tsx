      ...
      <Card title="Send a request">
        <div className="space-y-3">
          ...
          <label className="block text-xs font-medium text-slate-500">
            Prompt
            <textarea
              className="mt-1 h-32 w-full rounded-md border border-slate-300 p-2 text-sm"
              value={prompt}
      ...
      <div className="space-y-3">
        ...
        {results.map((r) => (
          <Card key={r.request_id}>
            ...
            <p className="whitespace-pre-wrap text-sm text-slate-700">{r.response}</p>
            <div className="mt-3 grid grid-cols-4 gap-2 border-t border-slate-100 pt-3 text-center text-xs">
              <div>
